...
def run(p_pb, of_pb, TET, cp, gamma):
    ...
    #CEA
    p_pb = p_pb  #[Pa]
    of_ratio_pb= of_pb # oxidizer fuel ratio
    T_i_t2 = TET #[K] (nice) turbine inlet temperature
    cp_t2= cp #[J/kg*K] constant pressure specific heat
    gamma_t2= gamma #C
    #genral
    g = 9.81 #[m/s^2]
    ...
    delta_p_cool = 3700000  #[Pa]
    delta_p_lines = 0.05*p_cc  #[Pa]
    ...
    print("P3 pressure rise", "%.2f"%delta_p_p_p3)                 
    ...
    print("P4 pressure rise", "%.2f"%delta_p_p_p4)
    ...
    print("P2 pressure rise", "%.2f"%delta_p_p_p2)                  
    T_p2= 200 #[K]                                                                              !                                                                 
    ...
    roh_p3 = CP.PropsSI("D","T", T_p3, "P", p_i_p3, "methane") #[kg/m^3]
    ...
    roh_p4 = CP.PropsSI("D","T", T_p4, "P", p_i_p4, "oxygen") #[kg/m^3]
    ...
    roh_p2 = CP.PropsSI("D","T", T_p2, "P", p_i_p2, "oxygen") #[kg/m^3]
    ...
    print("Pump Powers (p3, p4, p2)", "%.2f"%P_req_p3, "%.2f"%P_req_p4, "%.2f"%P_req_p2)
